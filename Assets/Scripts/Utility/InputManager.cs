...
public class InputManager : MonoBehaviour
{
    ...
    /// </summary>
    /// <param name="callbackContext">The context of the jump input</param>
    public void ReadSpeedUpInput(InputAction.CallbackContext context)
    {
        shiftPressed = !context.canceled;
        shiftHeld = !context.canceled;
        StartCoroutine("ResetSpeedUpStart");
    }
    ...
    /// </summary>
    /// <returns>IEnumerator: Allows this to function as a coroutine</returns>
    private IEnumerator ResetSpeedUpStart()
    {
        yield return new WaitForEndOfFrame();
        shiftPressed = false;
    }
